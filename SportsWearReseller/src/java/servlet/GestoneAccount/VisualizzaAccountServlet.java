...
public class VisualizzaAccountServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher rd=request.getRequestDispatcher("GestioneAccountVenditore.jsp");    
        rd.forward(request,response);    
        }
        else
        {
            RequestDispatcher rd=request.getRequestDispatcher("GestioneAccountCliente.jsp");    
            rd.forward(request,response);  
        }
    }
}
