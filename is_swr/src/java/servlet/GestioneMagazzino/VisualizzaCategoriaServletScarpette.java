 ...
 * @author carfo
 */
public class VisualizzaCategoriaServletScarpette extends HttpServlet {
     ...
     */
     protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        session.setAttribute("listaCat", MagazzinoManager.getInstance().listaProdottiCatogoria("Scarpette"));
