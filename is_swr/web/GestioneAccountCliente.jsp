...
<html>
	...
	<div id = "header">
            <table cellspacing="5">
                <tr>
                    ...
                    <td width="30%"> <img id="int" src="grafica/utente.jpg" width="280" height="80"></td>
                   <td width="15%">
                    ...
                    <td>
                        <form action="VisualizzaAccountServlet">
                           <input type="image" alt="Account" id = "utn" src="grafica/utenteover.jpg" name="utente" width="40" height="40"
	...
	<div id = "main">
         <table  cellspacing="10" class="admin3">
                 ...
                 <tr>
                     <td><h3>Indirizzo Società<h3></td><td><h4><%=a.getIndirizzo()%><h4></td>
                 </tr>
                 <tr>
                     <td>
